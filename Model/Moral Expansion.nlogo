...
to setup-neighbourhood
  ask n-of (total-population / 3) people with [my-neighbourhood = 0] [
    set my-neighbourhood "high-income"
    set access-to-education access-to-education-high-income
  ]
  ask n-of (total-population / 3) people with [my-neighbourhood = 0] [
    set my-neighbourhood "medium-income"
    set access-to-education access-to-education-medium-income
  ]
  ask people with [my-neighbourhood = 0] [
    set my-neighbourhood "low-income"
    set access-to-education access-to-education-low-income
  ]
